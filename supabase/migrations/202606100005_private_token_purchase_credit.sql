drop function if exists public.credit_wallet_purchase(uuid, integer, text, text);

create or replace function private.credit_wallet_purchase(
  target_user_id uuid,
...
revoke all on function private.credit_wallet_purchase(uuid, integer, text, text)
  from public, anon, authenticated;
grant execute on function private.credit_wallet_purchase(uuid, integer, text, text)
  to service_role;
