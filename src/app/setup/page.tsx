...
SUPABASE_SECRET_KEY=...`}</pre></CardContent></Card>
          <Card><CardHeader><CheckCircle2 className="text-cyan-600" /><CardTitle>3. Auth providers</CardTitle></CardHeader><CardContent className="space-y-2 text-sm leading-6 text-slate-600"><p>Bật Email và Google trong Supabase Auth.</p><p><strong>Production:</strong> Site URL = <code>https://lingora-ai.vercel.app</code>, thêm redirect <code>https://lingora-ai.vercel.app/auth/callback</code>.</p><p><strong>Local:</strong> thêm <code>http://localhost:3000/auth/callback</code>.</p></CardContent></Card>
